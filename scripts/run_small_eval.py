#!/usr/bin/env python3
"""
Small-Scale ProtoGalaxy Evaluation for Quick Testing & Paper Results
=====================================================================
...
Estimated Time:
  • Vanilla/Multi-Krum: ~4s/round → 10 rounds × 2 trials = ~1.3 min per experiment
  • ProtoGalaxy (merkle_only): ~5s/round → ~1.7 min per experiment
  • ProtoGalaxy (zk_merkle): ~20s/round → ~6.7 min per experiment
  
  Total: 2 partitions × 3 attacks × (2 baselines + 2 ablations) × 2 trials = 48 experiments
